...
/* Object.create создает новый объект, который прототипно наследует свойства и методы от указанного объекта. Изменения в унаследованном объекте никак не повлияют на родительский объект, но изменения в родительском объекте, наоборот, затронут и унаследованный объект, поскольку он ссылается на родительский через цепочку прототипов.
 */
